...
class Plant extends React.Component {
	componentDidMount() {
		const tree = document.querySelector("#animation")
		...
		hideWhenBoxInView.observe(tree);
		setTimeout(function () { document.querySelector(".animated-title").classList.add('opacity') }, 3500);
	}
	...
	render() {
		return (
			<div>
				...
				<svg id="animation" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 302.7 360.37">
					<defs>
